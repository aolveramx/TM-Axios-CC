// AXIOS GLOBALS
// globals set a header value with every request
...
// PUT/PATCH REQUEST
// PUT replaces hole resoruce, PATCH update incrementely
function updateTodo() {
...
axios.interceptors.request.use(config => {
  console.log(`${config.method.toUpperCase()} resuest sent to ${config.url} at ${new Date().getTime()}`)
  return config
}, error => {
